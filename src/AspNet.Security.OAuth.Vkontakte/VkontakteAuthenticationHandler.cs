...
{
    public class VkontakteAuthenticationHandler : UserInfoOAuthHandler<VkontakteAuthenticationOptions>
    {
        ...
        protected override JObject GetPayload(JObject content)
        {
            return content["response"].First as JObject;
        }
    }
}